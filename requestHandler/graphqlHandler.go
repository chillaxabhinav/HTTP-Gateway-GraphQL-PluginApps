...
func GraphQLRequestHandler() gin.HandlerFunc {
...
func PlaygroundHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write(graphiql.GetGraphiqlContent())
}
...
func GraphQLHandler(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println("BatchMode ", batchMode)
	...
	for _, operation := range operations {
		...
		// fmt.Println("requestContext ", requestContext)

		// Get the plan, and return a 400 if we can't get the plan
		GetPlan(requestContext) // TODO
		...
		// result, err = Execute(requestContext, plan)
		// if err != nil {
...
// func Execute(ctx *RequestContext, plans QueryPlanList) (map[string]interface{}, error) {
